...
static TAutoConsoleVariable<int32> CVarAnisotropicBRDF(
	...
	ECVF_ReadOnly | ECVF_RenderThreadSafe);
//Toon Shading [Sakura-2020-05-09]
static TAutoConsoleVariable<int32> CVarGBufferNECustomData(
	TEXT("r.AllowGBufferNECustomData"),
	0,
	TEXT("Whether enable custom data RT for GBuffer.\n")
	TEXT(" 0: disable \n")
	TEXT(" 1: enable"),
	ECVF_ReadOnly | ECVF_RenderThreadSafe);
//[Sakura]
